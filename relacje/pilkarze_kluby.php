...
while($row=$result->fetch_assoc()){
    ...
    <input type='text' name='Tabela' value='Piłkarz' hidden></br>
...
while($row=$result->fetch_assoc()){
    ...
    <input type='text' name='Tabela' value='Klub' hidden></br>
    <input type='submit' value='Usuń'>
    </form></td>");
    echo("</tr>");
}
...
while($row=$result->fetch_assoc()){
    ...
    <input type='text' name='Tabela' value='Klub_Pilkarz' hidden></br>
    <input type='submit' value='Usuń'>
    </form></td>");
    echo("</tr>");
}
