...
while($row=$result->fetch_assoc()){
    ...
    <input type='text' name='Mechanik' value='Mechanik' hidden></br>
...
while($row=$result->fetch_assoc()){
    ...
    <input type='text' name='Pojazd' value='Pojazd' hidden></br>
    <input type='submit' value='Usuń'>
    </form></td>");
    echo("</tr>");
}
...
while($row=$result->fetch_assoc()){
    ...
    <input type='text' name='Mechanik_Samochod' value='Mechanik_Samochod' hidden></br>
    <input type='submit' value='Usuń'>
    </form></td>");
    echo("</tr>");
}
